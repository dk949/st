...
static unsigned int const undercurlamplitude = 5 * font_scale;
...
static double const undercurlfreq = 1;              // This is in wavelegths/letter
...
// Ditto for undercurl
static unsigned int const undercurloffset = undercurlamplitude - 2 * font_scale;
...
static char const *colorname[] = {
    ...
    /* special colors */
    [256] = "#0B0E18", /* background */
    [257] = "#f8f8f2", /* foreground */

    // selection
    [258] = "#44475a",  // background
    [259] = "#000000",  // foreground // unused
};
...
// foreground-color Else if 1 keep original foreground-color of each cell =>
// more colors :)
